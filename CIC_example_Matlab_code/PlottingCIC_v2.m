...
bb = 1.5; %2.5 makes the failure probability too small to create a nice plot of approximation based only on the intial sample
kk = 0.1; ee = 0; %Table 2 example (instead of bb = 5)
...
% Varying k's 
for chosen_k = 1:k_max
    GM = best_models_by_k{chosen_k}; 
    ...
    fprintf('Plotting for k = %d.\n', chosen_k)
    save2pdf(strcat('Ex_CIC-IS_density_k',num2str(chosen_k)), gcf, 600);
end
