...
def runReplicate(seed):
    ...
    #sampleSize = [1000,]*7 + [2000,]
    sampleSize = [100,]
    procedure = cem.CEM(initParams,p,h,numIters=len(sampleSize),sampleSize=sampleSize,seed=seed,log=True,verbose=True)
    procedure.run()
